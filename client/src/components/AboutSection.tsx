const AboutSection = () => {
  return (
    <section id="sobre" className="section-container rounded-xl p-6 md:p-10 animate-fade-in-up shadow-xl">
      <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">Sobre o Jogo</h2>
      ...
      <div className="space-y-4 text-gray-200">
        ...
        <div className="flex flex-wrap gap-4 mt-6">
          <div className="flex items-center bg-dark-overlay p-4 rounded-lg">
